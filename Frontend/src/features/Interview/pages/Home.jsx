    ...
    return (
        <div className='home-page'>
            ...
            <div className='interview-card'>
                        ...
                        <div className='upload-section'>
                            ...
                            {selectedResume && (
                                <p className='upload-file-info'>
                                    Selected: <strong>{selectedResume.name}</strong> ({(selectedResume.size / 1024 / 1024).toFixed(2)} MB)
                                </p>
                            )}
                        </div>
                ...
                {errorMessage && <p style={{ color: '#ff6b6b', margin: '0 1.5rem 1.5rem' }}>{errorMessage}</p>}
            </div>
